...
//	glVertexAttribPointer(1, 4, GL_FLOAT, GL_FALSE, sizeof(Vertex), (void*)Vertex::colour);
...
//{
//	Framebuffer retval = { 0, width, height, ncolours,0,0,0,0,0,0,0 };
//
...
//	//////////////////////////////////////////////////////////////////////////////////
//
//	const GLenum attachments[8] = { GL_colour_ATTACHMENT0,GL_colour_ATTACHMENT1,
//									GL_colour_ATTACHMENT2, GL_colour_ATTACHMENT3,
//									GL_colour_ATTACHMENT4, GL_colour_ATTACHMENT5,
//									GL_colour_ATTACHMENT6, GL_colour_ATTACHMENT7 };
//
//	for (int i = 0; i < ncolours && i < 8; ++i)
//	{
//		retval.colours[i] = makeTexture(width, height, GL_RGBA, 0);
//		glFramebufferTexture(GL_FRAMEBUFFER, attachments[i], retval.colours[i].handle, 0);
//	}
//
//	glDrawBuffers(ncolours, attachments);
...
//{
//	for (unsigned i = 0; i < fb.ncolours; ++i)
//	{
//		freeTexture(fb.colours[i]);
//	}
//
